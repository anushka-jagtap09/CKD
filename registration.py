...
def insert():
    ...
    elif (un == "") or ((len(str(un)))<10 or len(str((un)))>10):
...
la = tk.Label(window, text="Note : Enter Mobile Nmber \n as a Username...!", width=40, font=("Times new roman", 10, "bold"), bg="black",fg="red")
